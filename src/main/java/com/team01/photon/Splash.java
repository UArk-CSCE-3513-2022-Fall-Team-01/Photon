...
class Splash {
	...
	private int t; //The time before the splash screen hides
    ...
    public void addImage(){        
        ImageIcon image = new ImageIcon(this.getClass().getResource("images/photon.jpg"));    // Creates ImageIcon component. 
