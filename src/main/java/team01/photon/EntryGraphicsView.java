...
public class EntryGraphicsView extends JFrame {
    ...
    public EntryGraphicsView(Game game) {
        ...
        try {
            herokuDB = new HerokuPostgreDatabase(
                    "postgres://kpzobqnwpafnyz:c2b612290e4aca89454e4c97e18d21cf0586baabdd41701f9c0162ce24cea4d7@ec2-52-207-90-231.compute-1.amazonaws.com:5432/d48c8dhcuoropm");
        } catch (Exception e) {
